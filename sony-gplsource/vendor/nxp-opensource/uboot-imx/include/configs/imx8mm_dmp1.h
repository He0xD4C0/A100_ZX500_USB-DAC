...
#define CONFIG_VIDEO_BMP_DMP_LOGO
#define CONFIG_VIDEO_KERNEL_LOGO_SIZE  (4 * 1024 * 1024)
#define CONFIG_FB_KERNEL_LOGO_ADDR_2G  0xb5b00000
#define CONFIG_FB_KERNEL_LOGO_ADDR_4G  0x135B00000
/* Reserve for kernel logo (KB) (optee + rpmesg + logo size) */
#define CONFIG_PRAM (168960)

/* Supported max size of uncompressed BMP */
#define CONFIG_SYS_VIDEO_LOGO_MAX_SIZE (3145728)

#define CONFIG_VIDEO_BMP_GZIP
#define CONFIG_IMX_VIDEO_SKIP
#define CONFIG_RM67191
#define CONFIG_HX8379C
#define CONFIG_HX83102D
#endif
