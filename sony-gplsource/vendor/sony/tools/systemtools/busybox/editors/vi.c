...
#define UNSET_READONLY_FILE(flags)      ((void)0)
	...
	char *_last_search_pattern; // last pattern from a '/' or '?' search
#endif
...
#define last_modified_count     (G._last_modified_count)
...
#define last_search_pattern     (G._last_search_pattern)
...
#define INIT_G() do { \
	...
	globs->_last_modified_count = -1; \
	/* "" but has space for 2 chars: */ \
	IF_FEATURE_VI_SEARCH(globs->_last_search_pattern = xzalloc(2);) \
} while (0)
