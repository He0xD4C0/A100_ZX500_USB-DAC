...
static struct imx_int_pll_rate_table imx8mm_fracpll_tbl[] = {
	...
	PLL_1443X_RATE(550000000U, 275, 3, 2, 0),
	PLL_1443X_RATE(500000000U, 250, 3, 2, 0),
	PLL_1443X_RATE(450000000U, 150, 2, 2, 0),
	PLL_1443X_RATE(400000000U, 200, 3, 2, 0),
	PLL_1443X_RATE(350000000U, 350, 3, 3, 0),
	PLL_1443X_RATE(300000000U, 300, 3, 3, 0),
	PLL_1443X_RATE(250000000U, 250, 3, 3, 0),
	PLL_1443X_RATE(200000000U, 200, 3, 3, 0),
	PLL_1443X_RATE(150000000U, 300, 3, 4, 0),
	PLL_1443X_RATE(100000000U, 200, 3, 4, 0),
	PLL_1443X_RATE(50000000U, 200, 3, 5, 0),
...
void dram_pll_init(enum dram_pll_out_val pll_val)
{
	...
	switch (pll_val) {
	case DRAM_PLL_OUT_50M:
		freq = 50000000UL;
		break;
	case DRAM_PLL_OUT_100M:
		freq = 100000000UL;
		break;
	case DRAM_PLL_OUT_150M:
		freq = 150000000UL;
		break;
	case DRAM_PLL_OUT_167M:
		freq = 167000000UL;
		break;
	case DRAM_PLL_OUT_200M:
		freq = 200000000UL;
		break;
	case DRAM_PLL_OUT_250M:
		freq = 250000000UL;
		break;
	case DRAM_PLL_OUT_266M:
		freq = 266666667UL;
		break;
	case DRAM_PLL_OUT_300M:
		freq = 300000000UL;
		break;
	case DRAM_PLL_OUT_350M:
		freq = 350000000UL;
		break;
	case DRAM_PLL_OUT_400M:
		freq = 400000000UL;
		break;
	case DRAM_PLL_OUT_450M:
		freq = 450000000UL;
		break;
	case DRAM_PLL_OUT_500M:
		freq = 500000000UL;
		break;
	case DRAM_PLL_OUT_550M:
		freq = 550000000UL;
		break;
	case DRAM_PLL_OUT_600M:
		freq = 600000000UL;
		break;
	case DRAM_PLL_OUT_650M:
		freq = 650000000UL;
		break;
	case DRAM_PLL_OUT_667M:
		freq = 667000000UL;
		break;
	case DRAM_PLL_OUT_700M:
		freq = 700000000UL;
		break;
